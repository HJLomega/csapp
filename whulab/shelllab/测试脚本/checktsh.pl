...
####################################################################
# checktsh - compare the output from tsh to the reference solution
#
...
{
    printf STDERR "$_[0]\n";
    printf STDERR "Usage: $0 [-h] -t <tracenum>\n";
...
sub check_trace {
    ...
    my $tshref = "./tshref";
    my $tmpdir = "/tmp/tsh$$";
    my $tshreffile = "$tmpdir/tshref.out";
    my $tshfile = "$tmpdir/tsh.out";
